...
const FoundationModels: React.FC<Props> = ({ compact }) => {
  const [animate, setAnimate] = useState(false);
  ...
  return (
    <section className={`flex flex-col items-center justify-center ${compact ? "py-10" : "py-20"} bg-black text-white`}>
      <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-500 to-blue-400">
        Foundation Models
      </h2>
      <p className="text-center max-w-2xl text-gray-300 mb-8 px-4 text-sm md:text-base">
        AI BlueMoon integrates OpenAI Assistants API and other leading LLMs to power specialized agents from Software Architects to QA.
      </p>
